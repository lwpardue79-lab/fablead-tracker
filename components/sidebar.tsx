...
export function Sidebar() {
  ...
  return <><aside className="fixed inset-y-0 left-0 z-20 hidden w-64 flex-col bg-steel text-white lg:flex">
    ...
    <div className="m-4 rounded-2xl border border-white/10 bg-white/5 p-4"><p className="text-xs font-semibold">Kansas City launch</p><p className="mt-1 text-xs leading-relaxed text-white/45">25 verified buyer pathways · nationwide-ready</p><div className="mt-3 h-1.5 rounded-full bg-white/10"><div className="h-full w-3/5 rounded-full bg-brand"/></div></div>
